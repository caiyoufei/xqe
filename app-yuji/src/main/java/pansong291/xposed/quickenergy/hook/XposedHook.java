...
public class XposedHook implements IXposedHookLoadPackage {
  ...
  public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
    ...
    if ("xqe.yuji".equals(lpparam.packageName)) {
      XposedHelpers.findAndHookMethod("pansong291.xposed.quickenergy.ui.MainActivity", lpparam.classLoader, "isModuleActive",
          new XC_MethodHook() {
            @Override
  ...
  private void hookLauncherService(ClassLoader loader) {
    ...
    try {
      XposedHelpers.findAndHookMethod(ClassMember.com_alipay_android_launcher_service_LauncherService, loader,
          ClassMember.onDestroy, new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
              if (wakeLock != null) {
                wakeLock.release();
