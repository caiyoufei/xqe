...
public class AntFarmRpcCall {
  ...
  public static String rpcCall_enterFarm(ClassLoader loader, String farmId, String userId) {
    try {
      String args1 = "[{\"animalId\":\"\",\"cityAdCode\":\""
          + cityAdCode
          + "\",\"districtAdCode\":\""
          + districtAdCode
          + "\",\"farmId\":\""
  ...
  public static String rpcCall_rewardFriend(ClassLoader loader, String consistencyKey, String friendId, String productNum,
      String time) {
    try {
  ...
  public static String rpcCall_sendBackAnimal(ClassLoader loader, String sendType, String animalId, String currentFarmId,
      String masterFarmId) {
    try {
      String args1 = "[{\"animalId\":\"" + animalId + "\",\"currentFarmId\":\""
          + currentFarmId + "\",\"masterFarmId\":\"" + masterFarmId +
