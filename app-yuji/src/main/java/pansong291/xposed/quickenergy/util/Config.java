...
public class Config {
  ...
  jn_enableFarm = "enableFarm",
      ...
      jn_dontSendFriendList = "dontSendFriendList", jn_recallAnimalType = "recallAnimalType", jn_receiveFarmToolReward =
      ...
      jn_useAccelerateTool = "useAccelerateTool", jn_feedFriendAnimalList = "feedFriendAnimalList", jn_notifyFriend =
      "notifyFriend",
